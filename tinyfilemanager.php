...
//$directories_users = array('user' => 'lcv_blog_github', 'admin' => 'lcv_blog_github');
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/lcv_blog_github';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = 'lcv_blog_github';
...
$allowed_upload_extensions = 'jpg,pdf';
...
$exclude_items = array('css','db','fonts','img','js','scss','*.php','*.dll','*.json','*.ico');
